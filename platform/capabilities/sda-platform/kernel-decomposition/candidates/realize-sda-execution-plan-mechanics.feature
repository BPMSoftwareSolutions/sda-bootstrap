...
Feature: Realize SDA execution-plan mechanics
  ...
  @outcome-terminal
  Scenario: Observe declared governed repository resources
  ...
  @outcome-terminal
  Scenario: Observe an admitted external representation
  ...
  @extracted-from:node-native-mechanic-providers.mjs#createGovernedEffectContext
  ...
  @outcome-terminal
  Scenario: Bind an authorized external credential reference
  ...
  @extracted-from:node-native-mechanic-providers.mjs#obtainGenericModelResponse
  ...
  @outcome-terminal
  Scenario: Invoke a governed model provider
  ...
  @extracted-from:node-native-mechanic-providers.mjs#loadFsShaper
  ...
  @outcome-terminal
  Scenario: Shape a batch of files within admitted roots
  ...
  @extracted-from:node-native-mechanic-providers.mjs#runsBoundedCommand
  @extracted-from:node-native-mechanic-providers.mjs#digestDirectory
  ...
  @outcome-terminal
  Scenario: Observe declared target executions without artifact drift
  ...
  @extracted-from:node-native-mechanic-providers.mjs#sda-projected-capability-invocation-port.v1
  @extracted-from:node-native-mechanic-providers.mjs#sda-projected-capability-invocation-port.v2
  @extracted-from:node-native-mechanic-providers.mjs#nestedExecutionTestimony
  ...
  @outcome-terminal
  Scenario: Invoke an admitted projected capability
  ...
  @outcome-terminal
  Scenario: Execute an authority-ordered capability sequence
  ...
  @extracted-from:node-native-mechanic-providers.mjs#resolveCanonicalCapabilityFeature
  @extracted-from:node-native-mechanic-providers.mjs#collectCanonicalFeatureDeclarations
  ...
  @outcome-terminal
  Scenario: Execute a declared tooling migration operation
  ...
  @outcome-terminal
  Scenario: Project a target-language mechanic registry
