...
Feature: Verify SDA execution-plan realization
  ...
  @extracted-from:node-native-mechanic-providers.mjs#expected-execution-trace.v1
  ...
  @extracted-from:node-native-mechanic-providers.mjs#artifact-binding-observation.v1
  ...
  @extracted-from:node-native-mechanic-providers.mjs#projected-origin-observation.v1
  ...
  @extracted-from:conformance-law
  ...
  @outcome-terminal
  Scenario: Verify platform mechanic resolution
  ...
  @outcome-terminal
  Scenario: Verify execution-mechanic parity across admitted languages
